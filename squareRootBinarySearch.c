...
//  If mid * mid equals n, mid is the square root. If mid * mid is less than n, search continues in the right half; otherwise, 
//  in the left half. The final answer
...
int main() {
    ...
    while (low <= high) {
        ...
        if (mid * mid == n) {
            ...
            low = mid + 1;   // search for a bigger value
        }
        else {
